...
export const config = {
  ...
  allowDevMock: (process.env.NODE_ENV !== "production" && process.env.VERCEL_ENV !== "production") && process.env.ALLOW_DEV_MOCK_PAYMENTS === "true",
  ...
  supabase: {
    url: process.env.SUPABASE_URL || configJson.supabaseUrl || "https://xpqduepvrlhzsofxcukn.supabase.co",
    anonKey: process.env.SUPABASE_ANON_KEY || configJson.supabaseAnonKey || "",
