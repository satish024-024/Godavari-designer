...
export async function getProductById(productId) {
  ...
  const rows = await supabaseFetch(`/rest/v1/products?id=eq.${encodeURIComponent(productId)}&select=id,code,title,price,slug,width,height,total_stitch_count,thread_colors,image,description,design_file`);
