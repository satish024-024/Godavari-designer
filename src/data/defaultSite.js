  ...
  collections: [
    {
      ...
      seoTitle: "Bridal Collection Collection | Godavari",
      seoDescription: "Browse the premium bridal collection embroidery collection."
    },
    {
      id: "blouses",
      ...
      seoTitle: "Designer Blouses Collection | Godavari",
      seoDescription: "Browse the premium designer blouses embroidery collection."
    },
    {
      id: "saree",
      title: "Saree Borders",
      ...
      seoTitle: "Saree Borders Collection | Godavari",
      seoDescription: "Browse the premium saree borders embroidery collection."
    },
    {
      id: "kids",
      title: "Kids Wear",
      ...
      seoTitle: "Kids Wear Collection | Godavari",
      seoDescription: "Browse the premium kids wear embroidery collection."
    },
    {
      id: "floral",
      title: "Luxury Floral",
      ...
      seoTitle: "Luxury Floral Collection | Godavari",
      seoDescription: "Browse the premium luxury floral embroidery collection."
    }
  ],
  steps: [
    {
  ...
  products: [
    {
      ...
      seoTitle: "Royal Peony Floral Design Motif (GD-1028) | Godavari",
      seoDescription: "Download the Royal Peony machine embroidery design motif. Optimized for silk, velvet, and organza fabrics. Available in DST, PES, EXP, and JEF.",
    ...
    },
    {
      ...
      seoTitle: "Bridal Gold Bloom Lehenga Embroidery Design (GD-2041) | Godavari",
      seoDescription: "Premium bridal gold bloom machine embroidery design with 58,000 stitches. Perfect for wedding lehengas, veils, and heavy boutique wear.",
    ...
    },
    {
      ...
      seoTitle: "Designer Vine Border Saree Embroidery Design (GD-1877) | Godavari",
      seoDescription: "Buy repeating vine border machine embroidery pattern for boutique saree border stitching. Seamless continuous looping, optimized for running stitch borders.",
    ...
    },
    {
      ...
      seoTitle: "Regal Paisley Motif Lehenga Embroidery Pattern (GD-3102) | Godavari",
      seoDescription: "Intricate traditional regal paisley patch design. Dense zari gold embroidery file with 41,000 stitches, ideal for bridal and wedding couture.",
    ...
    },
    {
      ...
      seoTitle: "Kids Floral Garden Dress Embroidery Design (GD-4058) | Godavari",
      seoDescription: "Soft mini floral garden machine embroidery pattern for kids festive wear. Low density stitch structure for comfortable, soft drape on child fabrics.",
    ...
    },
    {
      ...
      seoTitle: "Zari Leaf Trail Saree Border Embroidery Design (GD-2766) | Godavari",
      seoDescription: "Get the zari leaf border machine embroidery design with 25,500 stitches. Optimized for high-speed boutique production on wedding sarees.",
    ...
    },
    {
      ...
      seoTitle: "Cutwork Elegance Blouse Back-Neck Embroidery (GD-3345) | Godavari",
      seoDescription: "Exquisite cutwork back-neck designer blouse machine embroidery file. Clean satin stitch edges for perfect cutout guides. Compatible with DST, PES, EXP.",
    ...
    },
    {
      ...
      seoTitle: "Royal Neckline Collar Machine Embroidery Pattern (GD-5120) | Godavari",
      seoDescription: "Regal front-neck collar embroidery design with 22,000 stitches. Indian boutique style placement template for kurtas and wedding blouses.",
